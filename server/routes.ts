  ...
  app.put("/api/candidates/:id", async (req, res) => {
    try {
      ...
      const updatedCandidate = await storage.updateCandidate(id, {
        ...
        initials: req.body.initials !== undefined ? req.body.initials : existingCandidate.initials,
        profileImageUrl: req.body.profileImageUrl !== undefined ? req.body.profileImageUrl : existingCandidate.profileImageUrl,
        fullName: req.body.fullName !== undefined ? req.body.fullName : existingCandidate.fullName,
        title: req.body.title !== undefined ? req.body.title : existingCandidate.title,
        location: req.body.location !== undefined ? req.body.location : existingCandidate.location,
        skills: skillsData,
        experienceYears: experienceYearsData,
        bio: req.body.bio !== undefined ? req.body.bio : existingCandidate.bio,
        education: req.body.education !== undefined ? req.body.education : existingCandidate.education,
        availability: req.body.availability !== undefined ? req.body.availability : existingCandidate.availability,
        contactEmail: req.body.contactEmail !== undefined ? req.body.contactEmail : existingCandidate.contactEmail,
        contactPhone: req.body.contactPhone !== undefined ? req.body.contactPhone : existingCandidate.contactPhone,
